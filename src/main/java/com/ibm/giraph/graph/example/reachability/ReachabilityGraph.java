...
public class ReachabilityGraph
	...
	public void preApplication() throws InstantiationException,
	    ...
	    registerAggregator(ReachabilityGraph.BFS_AGG,BooleanOrAggregator.class );
	}
    ...
    private static class MyVertex extends LongLongLongLongVertex {
	@Override
	...
	if (args.length != 7) {
	    System.err
		    .println("run: Must have 5 arguments <input path> <output path> <# of workers> <hash partition: true, range partition: false> <BFS_SOURCE> <BFS_DEST>"
	...
	job.setWorkerContextClass(ReachabilityWorkerContext.class);
	...
	ReachabilityGraph.BFS_SOURCE = Integer.parseInt(args[5]);
	ReachabilityGraph.BFS_DEST = Integer.parseInt(args[6]);
